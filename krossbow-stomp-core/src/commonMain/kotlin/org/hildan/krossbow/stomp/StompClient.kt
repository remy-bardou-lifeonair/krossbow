 ...
 * Exception thrown when the websocket connection + STOMP connection takes too much time.
 */
class WebSocketConnectionTimeout(url: String, timeoutMillis: Long) :
    WebSocketConnectionException(url, "Timed out waiting for ${timeoutMillis}ms when connecting to $url")
