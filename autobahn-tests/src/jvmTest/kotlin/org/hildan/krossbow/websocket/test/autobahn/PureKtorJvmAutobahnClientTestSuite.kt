...
class PureKtorJvmAutobahnClientTestSuite {
    private val agentUnderTest: String = "pure-ktor-jvm"
    ...
    private fun runAutobahnTestCase(caseId: String) = runSuspendingTest {
        val ktorHttp = HttpClient(OkHttp) { install(WebSockets) }
...
private suspend fun HttpClient.connectAndGet(url: String): String {
    ...
    webSocket(url) {
        ...
        //expectCloseFrame("after JSON data for $url")
